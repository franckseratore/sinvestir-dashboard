...
def _default_targets() -> pd.DataFrame:
    ...
    return pd.DataFrame([
        ...
        {"indicateur": "benefice_net_paid",   "description": "Bénéfice net Paid mensuel",        "unite": "€",  "sens": "Haut", "target_2026": 600000,  "target_mensuelle": 50000,   "seuil_critique": 50000,   "owner": "Matthieu", "prorata": False},
