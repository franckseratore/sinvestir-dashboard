#!/usr/bin/env python3
"""
Rapport mensuel S'investir — script autonome.
Lancé le 1er de chaque mois à 09h00 par launchd.
"""
import sys
import duckdb
...
from app.weekly_report import send_monthly_report
import structlog

log = structlog.get_logger()

log.info("monthly_script_start")
